...
<div class="modal fade justify-content-center align-items-center dark-container" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
